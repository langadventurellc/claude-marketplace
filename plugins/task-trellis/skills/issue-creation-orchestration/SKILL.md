...
|------|-----------|---------|
| Issue creation | `task-trellis:trellis-issue-writer` | Creating/updating Trellis issues |
| Review | `task-trellis:trellis-issue-writer` | Issue verification |
...
- subagent_type: "task-trellis:trellis-issue-writer"
