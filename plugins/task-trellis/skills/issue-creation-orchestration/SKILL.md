...
|------|-----------|---------|
| Issue creation | `task-trellis:issue-writer` | Creating/updating Trellis issues |
| Review | `task-trellis:issue-writer` | Issue verification |
...
- subagent_type: "task-trellis:issue-writer"
